...
export default function BootstrapPage() {
  ...
  return (
    <main className="grid min-h-screen place-items-center px-6 py-12">
      ...
      >
        <p className="text-xs uppercase tracking-[0.32em] text-emerald-300">First light</p>
        <h1 className="mt-4 text-3xl font-semibold tracking-tight">Claim this installation</h1>
        ...
        <a className="mt-5 block text-center text-sm text-slate-400 underline underline-offset-4" href="/login">
